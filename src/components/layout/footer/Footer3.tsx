              ...
              >
                <div className="footer-widget__column footer-widget__links">
                  ...
                  <ul className="footer-widget__Explore-list list-unstyled">
                    ...
                    <li>
                      <Link href="/Conferences">Blog</Link>
                    </li>
                    <li>
              ...
              >
                <div className="footer-widget__column footer-widget__services">
                  ...
                  <ul className="footer-widget__services-list list-unstyled">
                    <li>
                      <Link href="/Conferences">Smartphone Repair</Link>
                    </li>
                    <li>
                      <Link href="/Conferences">Laptop Repair</Link>
                    </li>
                    <li>
                      <Link href="/Conferences">Desktop Repair</Link>
                    </li>
                    <li>
                      <Link href="/Conferences">Tablet Repair</Link>
                    </li>
                    <li>
                      <Link href="/Conferences">Smart Watch Repair</Link>
                    </li>
                  </ul>
                </div>
              </div>
