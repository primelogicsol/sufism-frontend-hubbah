    ...
    (c = (function () {
      ...
      return (
            ...
            r(this._element)
              ...
              .on(h.CLICK_DATA_API, function (t) {
                var e = r(this),
                  ...
                  s = i
                    .siblings(n._config.parentTrigger)
                    .children(n._config.triggerElement),
                  a = i.children(n._config.subMenu);
                n._config.preventDefault && t.preventDefault(),
                  "true" !== e.attr("aria-disabled") &&
                    (i.hasClass(n._config.activeClass)
                      ? (e.attr("aria-expanded", !1), n._hide(a))
                      : (n._show(a),
                        e.attr("aria-expanded", !0),
                        n._config.toggle && s.attr("aria-expanded", !1)),
                    n._config.onTransitionStart &&
                      n._config.onTransitionStart(t));
              });
        }),
        (a.prototype._show = function (t) {
          if (
            !this._transitioning &&
            !r(t).hasClass(this._config.collapsingClass)
          ) {
            var e = this,
              i = r(t),
              s = r.Event(h.SHOW);
        ...
        (a.prototype._hide = function (t) {
          if (
            !this._transitioning &&
            r(t).hasClass(this._config.collapseInClass)
          ) {
            var e = this,
              i = r(t),
              s = r.Event(h.HIDE);
          ...
          return this.each(function () {
            var t = r(this),
              ...
              i = r.extend(
                ...
                l,
                t.data(),
                "object" === (void 0 === s ? "undefined" : n(s)) && s,
              );
            if (
              (!e && /dispose/.test(s) && this.dispose(),
              e || ((e = new a(this, i)), t.data(o, e)),
              "string" == typeof s)
            ) {
              if (void 0 === e[s])
          ...
          this.each(function () {
            ...
            function s(t, e, i) {
              ...
              e &&
                ((e =
                  parseInt(m.css("top")) +
                  ((t * parseInt(_.wheelStep)) / 100) * m.outerHeight()),
              ...
              i(),
                ...
                p >= f.outerHeight()
                  ...
                  : (m.stop(!0, !0).fadeIn("fast"),
                    _.railVisible && y.stop(!0, !0).fadeIn("fast"));
            }
            function n() {
              _.alwaysVisible ||
              ...
              y.css(b),
                ...
                f.bind("touchstart", function (t, e) {
                  t.originalEvent.touches.length &&
                    (c = t.originalEvent.touches[0].pageY);
                }),
                f.bind("touchmove", function (t) {
                  g || t.originalEvent.preventDefault(),
                    t.originalEvent.touches.length &&
                      (s(
                        (c - t.originalEvent.touches[0].pageY) /
                          _.touchScrollStep,
                ...
                "bottom" === _.start
                  ? (m.css({ top: f.outerHeight() - m.outerHeight() }),
                    s(0, !0))
                  : "top" !== _.start &&
                    (s(w(_.start).position().top, null, !0),
                    _.alwaysVisible || m.hide()),
    ...
    (n.defaults = {
      ...
      (n.prototype.transition = function () {
        var r = this.$element,
          ...
          f =
            c.update && "function" == typeof c.update
              ? c.update
              : n.defaults.update,
            ...
            var n = setInterval(function () {
              (s = g
                ...
                "none" !== c.display_text &&
                  ((a = c.use_percentage
                    ? c.percent_format(t)
                    : c.amount_format(e, d, u)),
                  "fill" === c.display_text
                    ? r.text(a)
                    : "center" === c.display_text && (l.text(a), h.text(a))),
    ...
    (a.fn.progressbar = function (s) {
      return this.each(function () {
        var t = a(this),
          ...
          i = "object" == typeof s && s;
        e && i && a.extend(e.options, i),
          e || t.data("bs.progressbar", (e = new n(this, i))),
          e.transition();
      });
    }),
      ...
      (t = function () {
        ...
        (p = function (t, e, i, s, a) {
          ...
          for (
            t = (!1 === e ? parseFloat(t).toString() : t.toFixed(e)).split(""),
              (n = (n = z.inArray(".", t)) < 0 ? t.length : n) < t.length &&
                (t[n] = a),
              r = n - i;
            0 < r;
            r -= i
        ...
        (i = function (t) {
          ...
          ((e = k.createElement("style")).type = "text/css"),
            ...
            i
              ? (k.styleSheets[k.styleSheets.length - 1].cssText = t)
              : (e[
                  "string" == typeof k.body.style.WebkitAppearance
                    ? "innerText"
                    : "innerHTML"
                ] = t);
        }),
        (z.fn.simpledraw = function (t, e, i, s) {
          ...
          if (z.fn.sparkline.canvas === N) {
            ...
            if (r.getContext && r.getContext("2d"))
              ...
              if (!k.namespaces || k.namespaces.v)
                return (z.fn.sparkline.canvas = !1);
              k.namespaces.add(
                "v",
          ...
          return (
            t === N && (t = z(this).innerWidth()),
            e === N && (e = z(this).innerHeight()),
            (a = z.fn.sparkline.canvas(t, e, this, s)),
            (n = z(this).data("_jqs_mhandler")) && n.registerCanvas(a),
            a
          );
        }),
        ...
        (u = e({
          ...
          registerCanvas: function (t) {
            var e = z(t.canvas);
            (this.canvas = t),
              (this.$canvas = e).mouseenter(z.proxy(this.mouseenter, this)),
              e.mouseleave(z.proxy(this.mouseleave, this)),
              e.click(z.proxy(this.mouseclick, this));
          },
          reset: function (t) {
            (this.splist = []),
          ...
          updateDisplay: function () {
            ...
            if (this.over) {
              for (e = 0; e < n; e++)
                (i = a[e].setRegionHighlight(this.currentEl, l, h)) && (r = !0);
              if (r) {
                if (
                  (((s = z.Event("sparklineRegionChange")).sparklines =
                    this.splist),
                  this.$el.trigger(s),
                  this.tooltip)
                ) {
                  for (t = "", e = 0; e < n; e++)
                    t += a[e].getCurrentRegionTooltip();
          ...
          init: function (t) {
            ...
            (this.container = t.get("tooltipContainer") || k.body),
              ...
              z(window).bind(
                ...
                z.proxy(this.updateWindowDims, this),
              ),
              this.updateWindowDims();
          },
          updateWindowDims: function () {
            (this.scrollTop = z(window).scrollTop()),
              (this.scrollLeft = z(window).scrollLeft()),
              (this.scrollRight = this.scrollLeft + z(window).width()),
              this.updatePosition();
          },
          getSize: function (t) {
          ...
          return this.each(function () {
            ...
            if (
              ((t = function () {
                ...
                (t =
                  "html" === h || h === N
                    ? (((r = this.getAttribute(o.get("tagValuesAttribute"))) !==
                        N &&
                        null !== r) ||
                        (r = l.html()),
                      r.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(","))
                    : h),
                  (e =
                    "auto" === o.get("width")
                  ...
                  "auto" === o.get("height")
                    ? (o.get("composite") && z.data(this, "_jqs_vcanvas")) ||
                      (((s = k.createElement("span")).innerHTML = "a"),
                      l.html(s),
                      (i = z(s).innerHeight() || z(s).height()),
                      z(s).remove(),
                      (s = null))
                    : (i = o.get("height")),
                  o.get("disableInteraction")
                    ? (a = !1)
                    : (a = z.data(this, "_jqs_mhandler"))
                      ? o.get("composite") || a.reset()
                      : ((a = new u(this, o)),
                        z.data(this, "_jqs_mhandler", a)),
                  !o.get("composite") || z.data(this, "_jqs_vcanvas")
                    ? ((n = new z.fn.sparkline[o.get("type")](
                        this,
                        t,
                        o,
                        e,
          ...
          for (e = 0, i = y.length; e < i; e++)
            (t = y[e][0]),
              z(t).is(":visible") && !z(t).parents().is(":hidden")
                ? (y[e][1].call(t),
                  z.data(y[e][0], "_jqs_pending", !1),
                  s.push(e))
                : z(t).closest("html").length ||
                  z.data(t, "_jqs_pending") ||
                  (z.data(y[e][0], "_jqs_pending", !1), s.push(e));
          ...
          init: function (t, e) {
            ...
            (this.userOptions = e = e || {}),
              ...
              (this.tagOptionsPrefix =
                e.enableTagOptions &&
                (e.tagOptionsPrefix || a.tagOptionsPrefix)),
              (i =
                (n = this.getTagSetting("type")) === b
                  ? s[e.type || a.type]
                  : s[n]),
            ...
            if (this.tagValCache.hasOwnProperty(t)) e = this.tagValCache.key;
              ...
              if ((e = this.tag.getAttribute(n + t)) === N || null === e) e = b;
                ...
                for (
                  ...
                  e[(a = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] =
                    F(a[1].replace(/(^\s*)|(\s*$)/g, ""));
              else e = F(e);
        ...
        (z.fn.sparkline._base = e({
          ...
          setRegionHighlight: function (t, e, i) {
            ...
            return e > this.canvasWidth ||
              ...
              i < 0
              ? null
              : a !== (s = this.getRegion(t, e, i)) &&
                  (a !== N && n && this.removeHighlight(),
          ...
          getCurrentRegionTooltip: function () {
            ...
            if (
              (z.isArray(e) || (e = [e]),
              z.isArray(t) || (t = [t]),
              (r = this.options.get("tooltipFormatFieldlist")),
              (o = this.options.get("tooltipFormatFieldlistKey")),
              r && o)
            ) {
              for (l = [], n = t.length; n--; )
                (h = t[n][o]), -1 != (d = z.inArray(h, r)) && (l[d] = t[n]);
              t = l;
            }
            for (i = e.length, u = t.length, n = 0; n < i; n++)
              for (
                ...
                (t[d].isNull && g.get("tooltipSkipNull")) ||
                  ...
                  (a = p.render(t[d], g.get("tooltipValueLookups"), g)),
                  v.push('<div class="' + s + '">' + a + "</div>"));
          ...
          calcHighlightColor: function (t, e) {
            ...
            if (
              ...
              for (a = [], s = 4 === t.length ? 16 : 1, n = 0; n < 3; n++)
                a[n] = E(B.round(parseInt(i[n + 1], 16) * s * o), 0, 255);
              return "rgb(" + a.join(",") + ")";
            }
            return t;
          },
        ...
        (z.fn.sparkline.line = A =
          e(z.fn.sparkline._base, {
            type: "line",
            init: function (t, e, i, s, a) {
            ...
            drawNormalRange: function (t, e, i, s, a) {
              var n = this.options.get("normalRangeMin"),
                ...
                l = B.round((i * (r - n)) / a);
              this.target
                .drawRect(t, o, s, l, N, this.options.get("normalRangeColor"))
                .append();
            },
            render: function () {
              var t,
              ...
              if (
                ...
                for (
                  s = a = 0,
                    ...
                    I &&
                      (((b =
                        k.get("highlightSpotColor") &&
                        !k.get("disableInteraction")) ||
                        k.get("minSpotColor") ||
                        (k.get("spotColor") && w[i] === this.miny)) &&
                        (M -= B.ceil(I)),
                      (b ||
                        k.get("maxSpotColor") ||
                        (k.get("spotColor") && w[i] === this.maxy)) &&
                        ((M -= B.ceil(I)), (s += B.ceil(I))),
                      (b ||
                        ((k.get("minSpotColor") || k.get("maxSpotColor")) &&
                          (w[0] === this.miny || w[0] === this.maxy))) &&
                        ((a += B.ceil(I)), (R -= B.ceil(I))),
                      (b ||
                        k.get("spotColor") ||
                        k.get("minSpotColor") ||
                        (k.get("maxSpotColor") &&
                        ...
                        (R -= B.ceil(I))),
                    M--,
                    k.get("normalRangeMin") === N ||
                      k.get("drawNormalOnTop") ||
                      this.drawNormalRange(a, s, M, R, e),
                    o = [(r = [])],
                    u = d = null,
                    g = w.length,
                    C = 0;
                  ...
                  (l = _[C]),
                    ...
                    (h = w[C]),
                    (d =
                      (p = a + B.round((l - this.minx) * (R / t))) +
                      ((C < g - 1
                        ? a + B.round((c - this.minx) * (R / t))
                        : R) -
                        p) /
                        2),
                    (H[C] = [u || 0, d, C]),
                    ...
                    null === h
                      ? C &&
                        (null !== w[C - 1] && ((r = []), o.push(r)),
                        T.push(null))
                      : (h < this.miny && (h = this.miny),
                        h > this.maxy && (h = this.maxy),
                        r.length || r.push([p, s + M]),
                        (n = [p, s + B.round(M - M * ((h - this.miny) / e))]),
                        r.push(n),
                        T.push(n));
                for (f = [], v = [], m = o.length, C = 0; C < m; C++)
                  (r = o[C]).length &&
                    (k.get("fillColor") &&
                      (r.push([r[r.length - 1][0], s + M]),
                      v.push(r.slice(0)),
                      r.pop()),
                    2 < r.length && (r[0] = [r[0][0], r[1][1]]),
                    f.push(r));
                for (m = v.length, C = 0; C < m; C++)
                  S.drawShape(
                    v[C],
                    k.get("fillColor"),
                    k.get("fillColor"),
                ...
                if (I && k.get("valueSpots"))
                  for (
                    (y = k.get("valueSpots")).get === N && (y = new D(y)),
                      C = 0;
                    C < g;
                    C++
                  )
                    (x = y.get(w[C])) &&
                      S.drawCircle(
                        a + B.round((_[C] - this.minx) * (R / t)),
                        s + B.round(M - M * ((w[C] - this.miny) / e)),
                        I,
                        N,
                        x,
                      ).append();
                I &&
                  ...
                  null !== w[i] &&
                  S.drawCircle(
                    a + B.round((_[_.length - 1] - this.minx) * (R / t)),
                    s + B.round(M - M * ((w[i] - this.miny) / e)),
                    I,
                    N,
                    k.get("spotColor"),
                  ).append(),
                  this.maxy !== this.minyorg &&
                    (I &&
                      k.get("minSpotColor") &&
                      ((l = _[z.inArray(this.minyorg, w)]),
                      S.drawCircle(
                        a + B.round((l - this.minx) * (R / t)),
                        s + B.round(M - M * ((this.minyorg - this.miny) / e)),
                        I,
                        N,
                        k.get("minSpotColor"),
                      ).append()),
                    I &&
                      k.get("maxSpotColor") &&
                      ((l = _[z.inArray(this.maxyorg, w)]),
                      S.drawCircle(
                        a + B.round((l - this.minx) * (R / t)),
                        s + B.round(M - M * ((this.maxyorg - this.miny) / e)),
                        I,
                        N,
                        k.get("maxSpotColor"),
                      ).append())),
        ...
        (z.fn.sparkline.bar = O =
          e(z.fn.sparkline._base, a, {
            type: "bar",
            init: function (t, e, i, s, a) {
              var n,
                r,
                ...
                P = -1 / 0;
              for (
                O._super.init.call(this, t, e, i, s, a), c = 0, p = e.length;
                c < p;
                c++
              )
                ((n = "string" == typeof (k = e[c]) && -1 < k.indexOf(":")) ||
                  z.isArray(k)) &&
                  ((b = !0),
                  n && (k = e[c] = W(k.split(":"))),
                  (k = L(k, null)),
                  (r = B.min.apply(B, k)) < A && (A = r),
                  P < (o = B.max.apply(B, k)) && (P = o));
              (this.stacked = b),
                (this.regionShapes = {}),
                (this.barWidth = R),
                (this.barSpacing = M),
              ...
              (this.max = v = B.max.apply(B, h)),
                ...
                f < g
                  ? (S =
                      (((b && 0 <= v ? P : v) - g) / u) * this.canvasHeight) !==
                      B.ceil(S) && ((this.canvasHeightEf -= 2), (S = B.ceil(S)))
                  : (S = this.canvasHeight),
                (this.yoffset = S),
                z.isArray(i.get("colorMap"))
                  ...
                  : ((this.colorMapByIndex = null),
                    ...
                    this.colorMapByValue &&
                      ...
                      (this.colorMapByValue = new D(this.colorMapByValue))),
                (this.range = u);
            },
            getRegion: function (t, e, i) {
              ...
              if (
                ...
                return d.get("nullColor")
                  ? ((a = e
                    ...
                    (i = 0 < _ ? _ - 1 : _),
                    y.drawRect(b, i, this.barWidth - 1, 0, a, a))
                  : N;
              for (r = _, o = 0; o < l; o++) {
                if (((h = u[o]), m && h === g)) {
                  if (!p || c) continue;
          ...
          e(z.fn.sparkline._base, a, {
            ...
            renderRegion: function (t, e) {
              ...
              if (
                ...
                return (
                  e && (o = this.calcHighlightColor(o, h)),
                  c.drawRect(n, r, this.barWidth - 1, s - 1, o, o)
                );
            },
          })),
        (z.fn.sparkline.discrete = r =
          e(z.fn.sparkline._base, a, {
            type: "discrete",
            init: function (t, e, i, s, a) {
        ...
        (z.fn.sparkline.bullet = l =
          e(z.fn.sparkline._base, {
            ...
            renderRange: function (t, e) {
              ...
              return (
                e && (a = this.calcHighlightColor(a, this.options)),
                this.target.drawRect(0, 0, s - 1, this.canvasHeight - 1, a, a)
              );
            },
          ...
          e(z.fn.sparkline._base, {
            ...
            init: function (t, e, i, s, a) {
              var n,
                r = 0;
              if (
                (h._super.init.call(this, t, e, i, s, a),
                (this.shapes = {}),
                (this.valueShapes = {}),
                (this.values = e = z.map(e, Number)),
            ...
            renderSlice: function (t, e) {
              ...
              for (n = d.length, a = 0; a < n; a++) {
                if (((s = i = f), 0 < g && (s = f + u * (d[a] / g)), t === a))
                  return (
                    (r = l.get("sliceColors")[a % l.get("sliceColors").length]),
                    e && (r = this.calcHighlightColor(r, l)),
                    o.drawPieSlice(h, h, h - c, i, s, N, r)
                  );
                f = s;
              }
            },
        ...
        (z.fn.sparkline.box = _ =
          e(z.fn.sparkline._base, {
            type: "box",
            init: function (t, e, i, s, a) {
              _._super.init.call(this, t, e, i, s, a),
                (this.values = z.map(e, Number)),
            ...
            render: function () {
              var t,
                ...
                v = this.canvasHeight,
                m =
                  g.get("chartRangeMin") === N
                    ? B.min.apply(B, u)
                    : g.get("chartRangeMin"),
                y =
                  g.get("chartRangeMax") === N
                    ? B.max.apply(B, u)
                    : g.get("chartRangeMax"),
                b = 0;
              if (_._super.render.call(this)) {
                if (g.get("raw"))
                  g.get("showOutliers") && 5 < u.length
                    ? ((e = u[0]),
                      (t = u[1]),
                      (s = u[2]),
                      (a = u[3]),
                  ...
                  for (t = r = N, l = 0; l < d; l++)
                    t === N && u[l] > s - i * g.get("outlierIQR") && (t = u[l]),
                      u[l] < n + i * g.get("outlierIQR") && (r = u[l]);
                  (e = u[0]), (o = u[d - 1]);
                } else (t = u[0]), (r = u[d - 1]);
        ...
        (g = e({
          ...
          _calculatePixelDims: function (t, e, i) {
            ...
            (s = this._pxregex.exec(e)),
              (this.pixelHeight = s ? s[1] : z(i).height()),
              (s = this._pxregex.exec(t)),
              (this.pixelWidth = s ? s[1] : z(i).width());
          },
        ...
        (f = e(g, {
          ...
          replaceWithShapes: function (t, e) {
            ...
            for (s = n.length; s--; )
              r[(i = n[s])] && (n.splice(s, 1), delete this.shapes[i], (a = s));
            for (s = e.length; s--; )
              n.splice(a, 0, e[s].id), (this.shapes[e[s].id] = e[s]);
          },
          insertAfterShape: function (t, e) {
            var i,
              s = this.shapeseq;
        ...
        (v = e(g, {
          ...
          _drawShape: function (t, e, i, s, a) {
            ...
            return (
              ...
              (r =
                i === N
                  ? ' stroked="false" '
                  : ' strokeWeight="' + a + 'px" strokeColor="' + i + '" '),
              (o =
                s === N
                  ? ' filled="false"'
          ...
          _drawCircle: function (t, e, i, s, a, n, r) {
            return (
              ...
              (a === N
                ? ' stroked="false" '
                : ' strokeWeight="' + r + 'px" strokeColor="' + a + '" ') +
              (n === N
                ? ' filled="false"'
          ...
          _drawPieSlice: function (t, e, i, s, a, n, r, o) {
            ...
            if (a === n) return "";
            if (
              (n - a == 2 * B.PI && ((a = 0), (n = 2 * B.PI)),
              (h = e + B.round(B.cos(a) * s)),
              (c = i + B.round(B.sin(a) * s)),
              (p = e + B.round(B.cos(n) * s)),
              (u = i + B.round(B.sin(n) * s)),
              h === p && c === u)
            ) {
              if (n - a < B.PI) return "";
              (h = p = e + s), (c = u = i);
            ...
            return h === p && c === u && n - a < B.PI
              ...
              : ((l = [e - s, i - s, e + s, i + s, h, c, p, u]),
                (d =
                  r === N
                    ? ' stroked="false" '
                    : ' strokeWeight="1px" strokeColor="' + r + '" '),
                (g =
                  o === N
                    ? ' filled="false"'
          ...
          replaceWithShapes: function (t, e) {
            ...
            for (s[0].outerHTML = a, i = 1; i < t.length; i++)
              z("#jqsshape" + t[i]).remove();
          },
          insertAfterShape: function (t, e) {
            var i = z("#jqsshape" + t),
              s = this["_draw" + e.type].apply(this, e.args);
...
var pJS = function (t, e) {
  ...
  e && Object.deepExtend(d, e),
    ...
    (d.fn.particle = function (t, e, i) {
      if (
        ...
        if (t.value instanceof Array) {
          var s =
            t.value[Math.floor(Math.random() * d.particles.color.value.length)];
    ...
    (d.fn.particle.prototype.draw = function () {
      ...
      if (t.color.rgb)
        ...
        s =
          ...
          ")";
      switch (
        ((d.canvas.ctx.fillStyle = s), d.canvas.ctx.beginPath(), t.shape)
      ) {
        case "circle":
        ...
        case "polygon":
          d.fn.vendors.drawShape(
            d.canvas.ctx,
            t.x - e / (d.particles.shape.polygon.nb_sides / 3.5),
            t.y - e / 0.76,
            (2.66 * e) / (d.particles.shape.polygon.nb_sides / 3),
        ...
        case "star":
          d.fn.vendors.drawShape(
            d.canvas.ctx,
            t.x - (2 * e) / (d.particles.shape.polygon.nb_sides / 4),
            t.y - e / 1.52,
            (2 * e * 2.66) / (d.particles.shape.polygon.nb_sides / 3),
            d.particles.shape.polygon.nb_sides,
            2,
          );
          break;
    ...
    (d.fn.particlesCreate = function () {
      for (var t = 0; t < d.particles.number.value; t++)
    ...
    (d.fn.particlesUpdate = function () {
      for (var t = 0; t < d.particles.array.length; t++) {
        ...
        if (
          (d.particles.opacity.anim.enable &&
            (1 == e.opacity_status
              ? (e.opacity >= d.particles.opacity.value &&
                  (e.opacity_status = !1),
                (e.opacity += e.vo))
              : (e.opacity <= d.particles.opacity.anim.opacity_min &&
                  (e.opacity_status = !0),
                (e.opacity -= e.vo)),
            e.opacity < 0 && (e.opacity = 0)),
          d.particles.size.anim.enable &&
            (1 == e.size_status
              ? (e.radius >= d.particles.size.value && (e.size_status = !1),
                (e.radius += e.vs))
              : (e.radius <= d.particles.size.anim.size_min &&
                  (e.size_status = !0),
                (e.radius -= e.vs)),
        ...
        switch (
          (e.x - e.radius > d.canvas.w
            ? ((e.x = s.x_left), (e.y = Math.random() * d.canvas.h))
            : e.x + e.radius < 0 &&
              ((e.x = s.x_right), (e.y = Math.random() * d.canvas.h)),
          e.y - e.radius > d.canvas.h
            ? ((e.y = s.y_top), (e.x = Math.random() * d.canvas.w))
            : e.y + e.radius < 0 &&
              ((e.y = s.y_bottom), (e.x = Math.random() * d.canvas.w)),
        ...
        if (
          ...
          for (var a = t + 1; a < d.particles.array.length; a++) {
            ...
            d.particles.line_linked.enable && d.fn.interact.linkParticles(e, n),
              d.particles.move.attract.enable &&
                d.fn.interact.attractParticles(e, n),
              d.particles.move.bounce && d.fn.interact.bounceParticles(e, n);
          }
      }
    }),
    ...
    (d.fn.interact.bounceParticles = function (t, e) {
      var i = t.x - e.x,
        s = t.y - e.y;
      Math.sqrt(i * i + s * s) <= t.radius + e.radius &&
          ...
          if (d.tmp.bubble_duration_end) {
            if (null != i)
              (r =
                t +
                (t -
                  (s - (c * (s - t)) / d.interactivity.modes.bubble.duration))),
                "size" == a && (o.radius_bubble = r),
                "opacity" == a && (o.opacity_bubble = r);
            ...
            "size" == a && (o.radius_bubble = void 0),
              "opacity" == a && (o.opacity_bubble = void 0);
      }
      if (
        ...
        if (h <= d.interactivity.modes.bubble.distance) {
          if (0 <= a && "mousemove" == d.interactivity.status) {
            if (d.interactivity.modes.bubble.size != d.particles.size.value)
              if (d.interactivity.modes.bubble.size > d.particles.size.value) {
                0 <= (r = o.radius + d.interactivity.modes.bubble.size * a) &&
                  (o.radius_bubble = r);
              } else {
            ...
            if (
              ...
              if (
                ...
                (l = d.interactivity.modes.bubble.opacity * a) > o.opacity &&
        ...
        if (d.tmp.bubble_clicking) {
          (i = o.x - d.interactivity.mouse.click_pos_x),
            (s = o.y - d.interactivity.mouse.click_pos_y);
          var h = Math.sqrt(i * i + s * s),
            c = (new Date().getTime() - d.interactivity.mouse.click_time) / 1e3;
          c > d.interactivity.modes.bubble.duration &&
            (d.tmp.bubble_duration_end = !0),
            c > 2 * d.interactivity.modes.bubble.duration &&
    ...
    (d.fn.modes.repulseParticle = function (s) {
      if (
        ...
        "bounce" == d.particles.move.out_mode
          ? (0 < o.x - s.radius && o.x + s.radius < d.canvas.w && (s.x = o.x),
            0 < o.y - s.radius && o.y + s.radius < d.canvas.h && (s.y = o.y))
          : ((s.x = o.x), (s.y = o.y));
      } else if (
        d.interactivity.events.onclick.enable &&
        isInArray("repulse", d.interactivity.events.onclick.mode)
          ...
          p <= l &&
            (function () {
              ...
              if (
                ...
                var e = s.x + s.vx,
                  i = s.y + s.vy;
                e + s.radius > d.canvas.w
                  ? (s.vx = -s.vx)
                  : e - s.radius < 0 && (s.vx = -s.vx),
                  i + s.radius > d.canvas.h
                    ? (s.vy = -s.vy)
                    : i - s.radius < 0 && (s.vy = -s.vy);
              }
            })();
        } else
          0 == d.tmp.repulse_clicking && ((s.vx = s.vx_i), (s.vy = s.vy_i));
    }),
    ...
    (d.fn.vendors.checkOverlap = function (t, e) {
      for (var i = 0; i < d.particles.array.length; i++) {
        var s = d.particles.array[i],
          a = t.x - s.x,
          n = t.y - s.y;
        Math.sqrt(a * a + n * n) <= t.radius + s.radius &&
          ((t.x = e ? e.x : Math.random() * d.canvas.w),
          (t.y = e ? e.y : Math.random() * d.canvas.h),
          d.fn.vendors.checkOverlap(t));
      }
    }),
    (d.fn.vendors.createSvgImg = function (n) {
      var t = d.tmp.source_svg.replace(
          /#([0-9A-F]{3,6})/gi,
          function (t, e, i, s) {
            if (n.color.rgb)
              var a =
    ...
    (d.fn.vendors.drawShape = function (t, e, i, s, a, n) {
      ...
      for (var c = 0; c < r; c++)
        t.lineTo(s, 0), t.translate(s, 0), t.rotate(h);
      t.fill(), t.restore();
    }),
        ...
        if ("svg" == t) {
          ...
          e.open("GET", d.particles.shape.image.src),
            (e.onreadystatechange = function (t) {
              4 == e.readyState &&
                (200 == e.status
                  ? ((d.tmp.source_svg = t.currentTarget.response),
...
(Object.deepExtend = function (t, e) {
  ...
  (window.particlesJS = function (t, e) {
    ...
    (n.className = s),
      (n.style.width = "100%"),
      (n.style.height = "100%"),
      null != document.getElementById(t).appendChild(n) &&
